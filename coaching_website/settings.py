"""
Django settings for coaching_website project.
...
SECRET_KEY = 'django-insecure-$u!hvpydl@wy%y*sxhdd3p5ecau1d_u2p^yys8879^yhustdj0'
...
ROOT_URLCONF = 'coaching_website.urls'
...
WSGI_APPLICATION = 'coaching_website.wsgi.application'
